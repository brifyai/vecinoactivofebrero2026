...
import { ChatMessage, ChatRoom } from '../lib/api';
            ...
            <div className="lg:sticky lg:top-24 border border-white/10 rounded-2xl bg-black/20 backdrop-blur-sm overflow-hidden">
              <div className="flex flex-col lg:h-[calc(100vh-8rem)]">
                ...
                <div className="flex-1 overflow-y-auto">
                  {isLoading ? (
                    <div className="p-4 text-center text-gray-400">Cargando salas...</div>
                  ) : error ? (
                    ...
                    rooms.map((room) => (
                      <button
                        ...
                        className={`w-full p-4 flex items-center gap-3 hover:bg-white/5 transition-colors text-left ${
                          activeRoom?.id === room.id ? 'bg-emerald-500/10 border-l-2 border-emerald-500' : ''
                        }`}
                      >
                        <div className="relative">
