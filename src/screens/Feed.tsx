...
export function Feed() {
  ...
  return (
    <div className="flex min-h-screen justify-center">
      ...
      <div className="flex-1 max-w-2xl mx-4 lg:mx-8 space-y-6 lg:ml-[400px] lg:mr-[400px]">
        <header className="mb-8">
          <h1 className="text-2xl lg:text-3xl font-bold text-white mb-2 flex items-center gap-3">
            Noticias <MessageSquare className="w-8 h-8 text-emerald-400" />
          </h1>
          <p className="text-gray-400">Mantente al día con lo que sucede en tu barrio.</p>
        </header>

        <Card className="p-4 mb-8 bg-white/5 border-white/10">
          <div className="flex gap-4">
            ...
            <div className="flex-1">
              <input
                ...
                className="w-full bg-transparent border-none text-white placeholder-gray-500 focus:ring-0 focus:outline-none py-2"
              />
      ...
      <div className="hidden lg:block w-80 xl:w-96 border-l border-white/10 bg-black/20 backdrop-blur-sm fixed right-4 top-0 h-screen">
