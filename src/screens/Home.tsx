  ...
  return (
    <BackgroundProvider>
      <div className={`min-h-screen ${textClass} selection:bg-emerald-500/30`}>
        ...
        {/* Hero Section */}
        <section className="pt-32 lg:pt-40 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className={`text-3xl sm:text-4xl lg:text-6xl font-bold ${textWhiteClass} mb-6 leading-tight`}>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mt-12 max-w-4xl mx-auto">
              {stats.map((stat, index) => (
                <Card key={index} className="p-4 lg:p-6 text-center">
                  <div className="text-2xl lg:text-4xl font-bold text-emerald-400 mb-1">{stat.value}</div>
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className={`text-2xl lg:text-3xl font-bold ${textWhiteClass} mb-8 text-center`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {features.map((feature, index) => (
                <Card
                  key={index}
                  className="group p-6 hover:border-emerald-500/30 transition-all duration-300 cursor-default"
                >
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <Card className="p-8 lg:p-12 text-center border-emerald-500/30 bg-emerald-500/10">
              <h2 className={`text-2xl lg:text-3xl font-bold ${textWhiteClass} mb-6`}>
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <h3 className={`text-xl font-bold ${textWhiteClass}`}>Gran Asamblea General de Seguridad Vecinal</h3>
                    <p className={`${textMutedClass} text-sm`}>Sede Social, Tu Barrio • Comité de Seguridad</p>
                  </div>
                </div>
        ...
        <section className="py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className={`text-2xl lg:text-3xl font-bold ${textWhiteClass} mb-8`}>
              Noticias del Barrio
            </h2>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {news.map((item, index) => (
                <Card key={index} className="p-6 hover:border-emerald-500/30 transition-all duration-300 cursor-pointer">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className={`text-2xl lg:text-4xl font-bold ${textWhiteClass} mb-4`}>
        ...
        {/* Footer */}
        <footer className="py-12 px-4 sm:px-6 lg:px-8 border-t border-white/10 backdrop-blur-sm bg-black/20">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-emerald-500/20 rounded-xl flex items-center justify-center border border-emerald-500/30">
              ...
              <div className={`flex items-center gap-6 ${textMutedClass} text-sm`}>
                <button onClick={() => navigate('/terminos')} className="hover:text-white transition-colors">Términos</button>
                <button onClick={() => navigate('/privacidad')} className="hover:text-white transition-colors">Privacidad</button>
